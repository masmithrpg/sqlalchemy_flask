...
class Config(object):
    ...
    #---------------------------------
    APP_DBTYPE='IBMI' # IBMI=Use ODBC/SQLITE=Use SQLite Database
    ...
    APP_CONNSTRING = 'Driver={Client Access ODBC Driver (32-bit)};System=RGT;Uid=REMOTECMD;Pwd=REMOTE123;CommitMode=0;'
    #APP_CONNSTRING = 'DSN=*LOCAL;CommitMode=0;'
    #---------------------------------
    # IBM i Connections    
    #---------------------------------  
    APP_LIBRARY1='QIWS'
